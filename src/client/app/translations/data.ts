...
const LocaleTranslationData = {
	"en": {
		...
		"unit.delete.meters.use": "The following meters use",
	...
	"fr": {
		...
		"unit.delete.meters.use": "The following meters use\u{26A1}",
	...
	"es": {
		...
		"unit.delete.meters.use": "Los siguientes medidores usan",
